...
class QReplayDoublePrior(AbstractModel):
    ...
    def __init__(self, game, **kwargs):
        ...
        if kwargs.get("load", False) is False:
            ...
            self.model.add(Dense(len(self.environment.empty)*4, input_shape=self.state_size, activation="relu"))
        ...
        self.target_model.add(Dense(len(self.environment.empty)*4, input_shape=self.state_size, activation="relu"))
    ...
    def train(self, stop_at_convergence=False, **kwargs):
        ...
        for episode in range(1, episodes + 1):
            ...
            while True:
                ...
                experience.remember(state, action_index, reward, next_state, status)
